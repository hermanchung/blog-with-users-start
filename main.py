...
from forms import CreatePostForm, FlaskForm, CommentForm
...
#  children class attribute = relationship('parent class name', back_populates='psuedo column')
#
#
...
def login():
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            flash('No such user, check email!')
            return redirect(url_for('login'))
...
def show_post(post_id):
    ...
    if request.method == 'POST' and comment_form.validate_on_submit():
        if current_user.is_authenticated:
            ...
            flash('Need to login to post comment!')
            return redirect(url_for('login'))
    comment = Comment.query.all()
    return render_template("post.html", post=requested_post, form=comment_form, comments=comment, user_now=current_user)
...
def edit_post(post_id):
    ...
    if request.method == 'POST' and edit_form.validate_on_submit() and post.author == current_user:
